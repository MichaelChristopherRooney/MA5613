...
const static int test_insert_before_and_after_forward(){
	printf("Running test: %s\n", __FUNCTION__);
...
// Tests the insert before and insert after functions
const static int test_insert_before_and_after_backward(){
	printf("Running test: %s\n", __FUNCTION__);
...
const static int (*TEST_FUNCS[]) (void) = { 
